        ...
        match (tag, r.len()) {
            ...
            (3, n) if n >= 34 => {
                ...
                Some(Event::Call(CallPdu {
                    ...
                    group: flag(r[14]),
                    time: (r[15] != 0).then_some(TdmaTime {
                        tn: r[15],
                        frame: r[16],
                        multiframe: r[17],
                    }),
...
pub fn traffic_burst_layout(bytes: &[u8]) -> Option<(usize, bool)> {
...
pub const TB_FLAG_CRC_OK: u8 = 0x01;

pub const TB_FLAG_ENCRYPTED: u8 = 0x02;
...
pub const TETRA_CODEC: &str = "ACELP 4.6k";

pub const TB_BITS_AT: usize = 21;

pub const TB_BITS_AT_V1: usize = 17;
...
pub const TRAFFIC_BURST_TAG: u8 = 7;
...
pub const TRAFFIC_BURST_LEN_V1: usize = 1 + 1 + 1 + 1 + 1 + 8 + 4 + SLOT_BITS.div_ceil(8);

pub const TRAFFIC_BURST_LEN: usize = TRAFFIC_BURST_LEN_V1 + 4;
