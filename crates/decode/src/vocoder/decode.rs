...
fn inter32_1_3(x: &[i16], at: usize) -> i16 {
    const C: [i16; 32] = [
        -47, 59, -84, 125, -183, 263, -366, 500, -672, 893, -1185, 1587, -2182, 3179, -5287, 13496,
        27072, -6669, 3688, -2452, 1758, -1304, 981, -739, 553, -407, 294, -207, 142, -96, 66, -49,
    ];
    let mut s = 0i32;
...
fn inter32_m1_3(x: &[i16], at: usize) -> i16 {
    const C: [i16; 32] = [
        -49, 66, -96, 142, -207, 294, -407, 553, -739, 981, -1304, 1758, -2452, 3688, -6669, 27072,
        13496, -5287, 3179, -2182, 1587, -1185, 893, -672, 500, -366, 263, -183, 125, -84, 59, -47,
    ];
    let mut s = 0i32;
    for (i, &c) in C.iter().enumerate() {
