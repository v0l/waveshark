...
pub struct Rate {
    /// Megabits a second, as a person says it: 6, 9, 12, 18, 24, 36, 48, 54.
    pub mbps: u8,
...
impl Rate {
    ...
    pub fn cbps(&self) -> usize {
        self.bpsc * DATA_SUBCARRIERS.len()
    }
...
pub fn rate_of(bits: [u8; 4]) -> Option<Rate> {
    ...
    let (mbps, bpsc, coding) = match code {
        0b1101 => (6, 1, (1, 2)),
        0b1111 => (9, 1, (3, 4)),
        0b0101 => (12, 2, (1, 2)),
        0b0111 => (18, 2, (3, 4)),
